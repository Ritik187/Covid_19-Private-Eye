...
let country_list_element = document.getElementsByClassName(".country-list");
...
function createCountryList(){
    ...
    country_list.forEach( (country, index) => {
        ...
        var ul = document.getElementById('list-1');
        // console.log(ul);
        var li = document.createElement("li");
        let name=country.name;
        // console.log(name);
        let id_li2=`getdata('${country.name}')`;
        // console.log(id_li2);
        li.appendChild(document.createTextNode(name));
        li.setAttribute("id",name ); 

        li.setAttribute("onclick",id_li2);
        ul.appendChild(li);
        // console.log(li);
        // alert(li.id);
    })
